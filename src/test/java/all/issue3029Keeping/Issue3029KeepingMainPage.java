...
public class Issue3029KeepingMainPage {

    public WebDriver driver;
    public WebDriverWait wait;
    private JavascriptExecutor jsExecutor;

    public Issue3029KeepingMainPage(WebDriver driver, WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    ...
    @FindBy(xpath = "//a[@href='#/outbank/requests/request-storage']")
    public WebElement issueKeeping;
    ...
    @FindBy(xpath = "//label[@for='target']/parent::div[@class='itemGroup']//div[@class='css-1rtrksz select__value-container select__value-container--has-value']")
    public WebElement typeIssue;

    @FindBy(xpath = "//label[@for='fromPointId']/parent::div//div[@class='css-1rtrksz select__value-container select__value-container--has-value']")
    public WebElement fieldPointFrom;
    ...
    @FindBy(xpath = "//label[@for='toPointId']/parent::div//div[@class='css-1rtrksz select__value-container select__value-container--has-value']")
    public WebElement fieldPointTo;
    ...
    @FindBy(xpath = "//div[@class='checkboxInput__wrapper'][1]//div[@class='item-itemTable _widthCell-10-100'][6]//span[@class='item-itemTable__label']")
    ...
    public void addAttachment() {
        ...
        driver.findElement(By.xpath("//label[@for='quality']/parent::div//div[@class='css-1rtrksz select__value-container select__value-container--has-value']")).click();
