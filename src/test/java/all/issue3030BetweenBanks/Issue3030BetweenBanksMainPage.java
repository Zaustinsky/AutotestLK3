...
public class Issue3030BetweenBanksMainPage {
    ...
    @FindBy(xpath = "//a[@href='#/outbank/requests/request-between-banks']")
    public WebElement issueBetweenBanks;
    ...
    public void addAttachment() {
        ...
        driver.findElement(By.xpath("//label[@for='nominal']/parent::div//div[@class='css-1rtrksz select__value-container select__value-container--has-value']")).click();
        driver.findElement(By.xpath("//*[text()='100']")).click();
